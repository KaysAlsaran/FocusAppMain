...
export const historyStyles = StyleSheet.create({
  ...
  seedBtn: { backgroundColor: colors.accent },
  deleteBtn: { backgroundColor: colors.danger },
  actionText: { color: colors.background, fontWeight: '800' },

  statGrid: { flexDirection: 'row', gap: 12, marginBottom: 18 },
  statCard: { flex: 1, backgroundColor: colors.surface, padding: 14, borderRadius: 14, borderWidth: 1, borderColor: colors.border, shadowColor: colors.primary, shadowOpacity: 0.12, shadowRadius: 6, elevation: 2 },
