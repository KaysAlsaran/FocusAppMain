      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        {mode !== 'summary' && (
          <View style={styles.btnRow}>
            <AppButton title="Başlat" onPress={handleStart} icon="play" color={colors.primary} style={{ flex: 1 }} />
            <AppButton title="Duraklat" onPress={handlePause} icon="pause" color={colors.warning} style={{ flex: 1 }} />
